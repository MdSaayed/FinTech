    ...
    return (
        <div className="flex flex-col md:flex-row justify-between items-center border-t border-gray-200 mt-12 pt-6 text-sm text-gray-600">
            <p className="text-center text-base text-gray-700">
                Copyright Designed by <Link to="https://www.uibazar.com" className="text-purple-600 hover:underline font-geist text-base">UiBazar</Link> and Powered by <Link to="https://www.react.com" className="text-purple-600 hover:underline font-geist text-base">React</Link>
            </p>
